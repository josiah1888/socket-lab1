...
class SimpleEchoClient
{
    ...
    public static void Main(string[] args)
    {
        ...
        Console.WriteLine("Do you want to send a file");
        string choice = Console.ReadLine();
        if (choice.Contains("Y") || choice.Contains("y"))
        {
            Console.WriteLine("Enter the file name");
            string fName = Console.ReadLine();
            string clientFile = @"C:\Users\Vladimir\Documents\Visual Studio 2015\Projects\Client\" + fName;
            string words = File.ReadAllText(clientFile);
            server.Send(Encoding.ASCII.GetBytes(words));
        }
